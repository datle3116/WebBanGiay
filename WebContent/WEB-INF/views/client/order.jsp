...
<body style="background-color: grey">
	...
	<form:form action="${pageContext.servletContext.contextPath}/cart/order.htm"
		...
		<div class="form-group">
			...
			<div class="form-group">
				...
				<form:input type="email" class="form-control" path="customerEmail" />
				<form:errors path="customerEmail" class="badge badge-danger"/>
			</div>
			<div class="form-group">
				<label><span
					class="badge badge-pill badge-warning">Số Điện Thoại:</span></label>
				<form:input type="number" class="form-control" path="customerPhone" />
