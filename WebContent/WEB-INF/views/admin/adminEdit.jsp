...
<body>
	...
	<form:form action="${pageContext.servletContext.contextPath}/admin/adminEdit/${ediProd.code}.htm" modelAttribute="ediProd" method ="POST" enctype="multipart/form-data">
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
						<td>
							<ul>
								<li>Ảnh: ${ediProd.image} </li>
								<li><input name="prodimage" type="file" /></li>
							</ul>
						</td>
						<td><form:input path="code" value="${ediProd.code}" readonly="true"/></td>
						<td><form:input path="name" value="${ediProd.name}" /></td>
						<td><form:input path="type" value="${ediProd.type}" /></td>
						<td><form:input path="price" value="${ediProd.price}" /> đồng</td>
